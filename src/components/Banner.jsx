                ...
                <div className="row">
                    <div className="col-lg-8 col-md-12 col-sm-12">
                        <div className="banner-content">
                            ...
                            <p>Web Developer specializing in Full Stack development and also have a pretty much knowledge in numerous programming languages Python, C, Java, JavaScript, and SQL & NoSQL Databases.</p>
                            <div className="social-links">
                                ...
                                <a href="facebook.com/gokul.gandhi.39" className="facebook">
                            ...
                            <div className="banner-buttons">
                                <a href="#" className="link project-button mx-2">EXPLORE PROJECTS</a>
